...
1	1	<< Flyway Baseline >>	BASELINE	<< Flyway Baseline >>	\N	null	2022-07-02 22:08:11.789008	0	t
2	1.1	data	SQL	V1.1__data.sql	-1723036001	postgres	2022-07-02 22:21:01.964345	22	t
\.
...
1	MLM	1-10	Tanjung karang 1-10	5
\.
...
5	chan123@gmail.com	chandra	aja	3246245	$2a$10$7ILi6aGNNb4cl7vGQRwVFexikEZcy75IdtycjG1Yk8ZDguXyxby/2	chan2
1	chan@gmail.com	Jackie	chan	1378234	chan123	chan
\.
...
SELECT pg_catalog.setval('public.tb_agency_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.tb_bus_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.tb_stop_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.tb_trip_schedule_id_seq', 3, true);
...
--
-- Name: tb_agency uk68bqlrxaeq2a98j4nf1kqqq2t; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tb_agency
    ADD CONSTRAINT uk68bqlrxaeq2a98j4nf1kqqq2t UNIQUE (code);
